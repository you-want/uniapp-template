  ...
  const run = () => {
    ...
    const chooseFileOptions = {
      ...
      success: (res: any) => {
        ...
        // App中res:{errMsg: "chooseImage:ok", tempFilePaths: "file:///Users/xxx/gallery/1522437259-compressed-IMG_0006.jpg", tempFiles: [File]}
        // App的File有以下字段：{path: "file:///Users/xxx/gallery/1522437259-compressed-IMG_0006.jpg", size: 48976}
        let tempFilePath = ''
        let size = 0
        // #ifdef MP-WEIXIN
